...
namespace Remalux.AR
{
    public class MeshBuilder : MonoBehaviour
    {
        ...
        public GameObject CreateWallMesh(WallSegment wall)
        {
            ...
            // Добавляем небольшой отступ от пола для лучшего визуального эффекта
            float floorOffset = 0.01f;

            Vector3[] vertices = new Vector3[]
            {
                new Vector3(-halfLength, floorOffset, 0),
                new Vector3(halfLength, floorOffset, 0),
            ...
            // Добавляем компонент для взаимодействия с коллизиями
